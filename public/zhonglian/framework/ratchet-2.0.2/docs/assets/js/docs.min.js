...
$(function () {
  ...
  var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r = function () {
    ...
    p = !0, b.on("click", function (a) {
      ...
      var a = $(".docs-nav-group"), b = $(".js-docs-nav-trigger");
      ...
      var a = $(".docs-components"), b = $(this).attr("data-platform");
    ...
    if (!(768 >= c)) {
      var e, f = n.scrollTop();
      if (b.length) {
        b.initialTop - f <= b.dockingOffset ? (b[0].className = "device device-fixed", b.css({top: b.dockingOffset})) : (b[0].className = "device", b[0].setAttribute("style", ""));
        for (var g = k.length; g--;)if (m[g] - f < d) {
          if (l === g)return;
    ...
    var a = n.scrollTop(), b = $(".docs-sub-header").outerHeight();
  ...
  a.prototype = {
    x: 0 / 0, y: 0 / 0, startDistance: 0 / 0, startAngle: 0 / 0, mouseIsDown: !1, listen: function () {
      function a(a, b) {
        var c, d, e;
        if (a) {
          if ("compareDocumentPosition"in b)return !!(16 & b.compareDocumentPosition(a));
          if ("contains"in b)return b !== a && b.contains(a);
          for (c = b.getElementsByTagName("*"), d = 0; e = c[d++];)if (e === a)return !0;
          return !1
        }
      }

      var b = this.activate.bind(this), c = this.deactivate.bind(this);
      ...
      if (this.target) {
        ...
        if (c.push(g), c.length > 1) {
          var h = c[0].pageX - c[1].pageX, i = c[0].pageY - c[1].pageY, j = Math.sqrt(Math.pow(h, 2) + Math.pow(i, 2)), k = Math.atan2(h, i) * (180 / Math.PI), l = "gesturechange";
