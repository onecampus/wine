...
function orderSuccessHan(orderNumber) {
  alert("您的商品购买成功！");
  location.href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa2bbd3b7a22039df&redirect_uri=http://shop.fszljy.com/wechatpay/js_api_call_pay&response_type=code&scope=snsapi_base&state=" + orderNumber + "#wechat_redirect";
}
